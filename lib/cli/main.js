...
var npwcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = npwcorenode.version;
  var create = npwcorenode.scaffold.create;
  var add = npwcorenode.scaffold.add;
  var start = npwcorenode.scaffold.start;
  var remove = npwcorenode.scaffold.remove;
  var callMethod = npwcorenode.scaffold.callMethod;
  var findConfig = npwcorenode.scaffold.findConfig;
  var defaultConfig = npwcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the NPW database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with npwcore Node configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `npwcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ npwcore-node add wallet-service');
      console.log('    $ npwcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ npwcore-node remove wallet-service');
      console.log('    $ npwcore-node remove insight-api');
      console.log();
    });
