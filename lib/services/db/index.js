...
DB.prototype._setDataPath = function() {
  ...
  if (this.node.network === 'livenet' || this.node.network === 'mainnet') {
    this.dataPath = this.node.datadir + '/npwcorenode.db';
  } else if (this.node.network === 'regtest') {
    this.dataPath = this.node.datadir + '/regtest/npwcorenode.db';
  } else if (this.node.network === 'testnet') {
    this.dataPath = this.node.datadir + '/testnet/npwcorenode.db';
  } else {
