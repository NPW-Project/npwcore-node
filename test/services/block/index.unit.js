...
describe('Block Service', function() {
  ...
  var block1 = Block.fromString('');
  var block2 = Block.fromString('');
  ...
  describe('#_detectReorg', function() {
    it('should detect reorg', function() {
      var block = Block.fromString(blocks[6]).toObject();
      blockService._tip = { hash: utils.revHex(Block.fromString(blocks[5]).header.prevHash) };
      expect(blockService._detectReorg(block)).to.be.true;
    });

    it('should not detect reorg', function() {
      var block = Block.fromString(blocks[6]).toObject();
      blockService._tip = { hash: utils.revHex(Block.fromString(blocks[6]).header.prevHash) };
  ...
  //   it('should start the sync of blocks', function(done) {
