...
describe('Header Service', function() {
  ...
  var headerService;
  var sandbox;
  var prevHeader = Block.fromString('').header.toObject();
  var preObjectHeader = Block.fromString('').header;
  ...
  describe('#start', function() {
    ...
    it('should get prefix for database', function(done) {
      var getServiceTip = sandbox.stub().callsArgWith(1, null, { height: 0, hash: '00' });
  ...
  describe('#getAllHeaders', function() {
    ...
    it('should get all the headers', function(done) {
      ...
      headerService.getAllHeaders(function(err, headers) {
        ...
        expect(headers.get(header.hash).hash).to.equal('15bf62317e1322b43c83bee2a2f238de15ab653dc7db585014431dd7b9188dcf');
        done();
      });
  ...
  describe('#_onHeaders', function() {
    ...
    it('should handle new headers received', function() {
      var headers = [preObjectHeader.toObject()];
