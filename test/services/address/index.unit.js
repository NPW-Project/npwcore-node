...
describe('Address Service', function() {
  ...
  var tx = new Tx('').toObject();
  ...
  describe('#_getAddressTxidHistory', function() {
    it('should get the address txid history', function(done) {
      ...
      var addressInfoBuf = addressService._encoding.encodeAddressIndexKey('a', 10, tx.hash, 1, 1, 1234567);
      ...
      addressService._getAddressTxidHistory('a', options, function(err) {
        ...
        expect(options.txIdList).to.deep.equal([{txid: tx.hash, height: 10}]);
        done();
  ...
  describe('#AddressSummary', function() {
    ...
    it('should get the address summary, incoming', function(done) {
      ...
      _tx.__inputScripts = [
        '76a914c342bcd1a7784d9842f7386b8b3b8a3d4171a06e88ac',
        '76a914c342bcd1a7784d9842f7386b8b3b8a3d4171a06e88ac',
        '76a914c342bcd1a7784d9842f7386b8b3b8a3d4171a06e88ac',
        '76a914c342bcd1a7784d9842f7386b8b3b8a3d4171a06e88ac'
      ];
      ...
      addressService.getAddressSummary('NdiQuArtpB1HcqQkrR2vNqiXYwXgffamzT', {}, function(err, res) {
        if (err) {
          return done(err);
        }
        expect(res).to.deep.equal({ addrStr: 'NdiQuArtpB1HcqQkrR2vNqiXYwXgffamzT',
          balance: 0.005,
          balanceSat: 500000,
          totalReceived: 0.005,
  ...
  describe('#getAddressUnspentOutputs', function() {
    it('should get address utxos', function(done) {
      ...
      var data = {
        ...
        value: encoding.encodeUtxoIndexValue(123, 120000, ts, npwcore.Script(tx.outputs[1].script).toBuffer())
      };
  ...
  describe('#onReorg', function() {
    ...
    it('should reorg when there is nothing to reorg', function(done ) {
      ...
      var commonAncestorHeader = npwcore.Block.fromString(blocks[5]).header.toJSON();
      var block = npwcore.Block.fromString(blocks[6]);
      block.__ts = 55555;
      block.__height = 999;
      var oldBlocks = [block];
