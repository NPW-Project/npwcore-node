...
The transaction service provides a transaction index for the NPW blockchain. Specifically, it builds and maintains the following information about every transaction on the NPW network:
