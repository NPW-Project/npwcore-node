...
var dbPath = '/Users/chrisk/.bwdb/npwcore-node.db';
...
var address = 'NgaBcBHkx635RHm5sEZ1tqRAuwwT61Qgn8';
...
stream.on('data', function(data) {
  ...
  var transaction = new npwcore.Transaction(data.value.slice(inputValues.length * 8 + 14));
